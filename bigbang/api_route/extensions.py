...
import bigbang.extensions
from bigbang.api_route import policy
...
class RequestExtension(object):
    """Extend requests and responses of core bigbang OpenStack API controllers.

    Provide a way to add data to responses and handle custom request data
    that is sent to core bigbang OpenStack API controllers.
    """
...
class ActionExtension(object):
    """Add custom actions to core bigbang OpenStack API controllers."""
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in bigbang."""
...
# of bigbang.extensions
def get_extensions_path():
    paths = ':'.join(bigbang.extensions.__path__)
